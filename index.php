  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap"  id="home-section">
      ...
      <div class="owl-carousel slide-one-item">
        ...
        <a href="#"><img src="asset/images/hero_3.jpg" alt="Image" class="img-fluid"></a>
        <a href="#"><img src="asset/images/hero_4.jpg" alt="Image" class="img-fluid"></a>
      ...
      <div class="site-section bg-image overlay counter" style="background-image: url('asset/images/hero_1_no-text.jpg'%}');" id="about-section">
        <div class="container">
          <div class="row mb-5">
